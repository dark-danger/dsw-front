...
export const MailSetupScreen: React.FC<MailSetupScreenProps> = ({
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 md:p-8 animate-in fade-in zoom-in-95 duration-200">
      <div className="max-w-xl w-full glass-panel p-8 md:p-10 shadow-2xl relative overflow-hidden border border-emerald-500/20">
        {/* Background glow */}
        ...
        <div className="relative z-10 space-y-6 text-center">
          {/* Main Icon */}
          <div className="w-18 h-18 mx-auto rounded-3xl bg-gradient-to-tr from-emerald-600 via-teal-600 to-emerald-400 flex items-center justify-center text-white shadow-xl shadow-emerald-500/25 border border-white/20">
          ...
          {/* User Account Pill */}
          <div className="p-3.5 bg-[var(--card-bg-to)] rounded-2xl border border-[var(--panel-border)] flex items-center justify-between text-left">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[11px] font-mono text-emerald-600 dark:text-emerald-400 flex items-center gap-1">
                  <Lock className="w-3 h-3 text-emerald-500" /> {user?.email}
                </div>
              </div>
            </div>
