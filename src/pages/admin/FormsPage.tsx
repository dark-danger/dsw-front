...
export const FormsPage: React.FC = () => {
  ...
  const [upiId, setUpiId] = useState('dsw@geeta.edu.in');
  const [upiPayeeName, setUpiPayeeName] = useState('Geeta University DSW');
  ...
  const handleApplyTemplate = (purpose: string) => {
    ...
    if (purpose === 'Event Registration with Fee') {
      ...
      setUpiId('dsw@geeta.edu.in');
      setUpiPayeeName('Geeta University DSW');
                    ...
                    <div className="space-y-3 pt-2 border-t border-amber-200 dark:border-amber-900/40">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder="Geeta University DSW"
                          className="glass-input text-xs"
                        />
                      </div>
